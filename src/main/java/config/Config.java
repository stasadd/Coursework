...
public abstract class Config {
    ...
    static {
        ...
        taskModels.add(new TaskModel("Медіа резонанас: відобразити та порівняти глобальну інформацію про два YouTube канали, враховуючи кількість коментарів", true, 1));
